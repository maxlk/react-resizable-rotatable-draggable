...
var StyledResizableRotatableRect = styled.div.withConfig({
  displayName: "StyledResizableRotatableRect",
  componentId: "ktrpwr-0"
})(["pointer-events:none;position:absolute;border:1px solid #eb5648;.square{position:absolute;width:7px;height:7px;background:white;border:1px solid #eb5648;border-radius:1px;}.resizable-handler{pointer-events:auto;position:absolute;width:14px;height:14px;cursor:pointer;z-index:1;&.tl,&.t,&.tr{top:-7px;}&.tl,&.l,&.bl{left:-7px;}&.bl,&.b,&.br{bottom:-7px;}&.br,&.r,&.tr{right:-7px;}&.l,&.r{margin-top:-7px;}&.t,&.b{margin-left:-7px;}}.rotate{pointer-events:auto;position:absolute;left:50%;top:-26px;width:18px;height:18px;margin-left:-9px;display:flex;justify-content:center;align-items:center;cursor:pointer;}.t,.tl,.tr{top:-3px;}.b,.bl,.br{bottom:-3px;}.r,.tr,.br{right:-3px;}.tl,.l,.bl{left:-3px;}.l,.r{top:50%;margin-top:-3px;}.t,.b{left:50%;margin-left:-3px;}"]);
...
var ResizableRotatableRect =
/*#__PURE__*/
function (_PureComponent) {
  _inherits(ResizableRotatableRect, _PureComponent);

  function ResizableRotatableRect() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, ResizableRotatableRect);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ResizableRotatableRect)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ResizableRotatableRect, [{
    key: "render",
    value: function render() {
      ...
      return React__default.createElement(StyledResizableRotatableRect, {
  ...
  return ResizableRotatableRect;
}(React.PureComponent);

_defineProperty(ResizableRotatableRect, "propTypes", {
...
var ResizableRotatable =
/*#__PURE__*/
function (_Component) {
  _inherits(ResizableRotatable, _Component);

  function ResizableRotatable() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, ResizableRotatable);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ResizableRotatable)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ResizableRotatable, [{
    key: "render",
    value: function render() {
      ...
      return React__default.createElement(ResizableRotatableRect, {
        children: children,
        className: className,
        styles: styles,
        zoomable: zoomable,
  ...
  return ResizableRotatable;
}(React.Component);

_defineProperty(ResizableRotatable, "propTypes", {
  className: PropTypes.string,
  children: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
...
_defineProperty(ResizableRotatable, "defaultProps", {
  className: '',
  parentRotateAngle: 0,
  rotateAngle: 0,
  rotatable: true,
...
var MAIN_MOUSE_BUTTON$1 = 0;
var DraggableRect =
/*#__PURE__*/
function (_PureComponent) {
  _inherits(DraggableRect, _PureComponent);
  ...
  function DraggableRect() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DraggableRect)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "startDrag", function (e) {
      if (e.button !== MAIN_MOUSE_BUTTON$1) return;
      var lastX = e.clientX,
          lastY = e.clientY;
      var startX = lastX;
      var startY = lastY;
      ...
      var _this$props = _this.props,
          dragStartThreshold = _this$props.dragStartThreshold,
          dragStartTimeThreshold = _this$props.dragStartTimeThreshold;
      var startDragTimer = setTimeout(function () {
        dragStarted = true;
        startX = lastX;
        startY = lastY;
      ...
      var onMove = function onMove(e) {
        ...
        if (e.shiftKey) {
          if (Math.abs(deltaX) > Math.abs(deltaY)) {
            _this.props.onDrag(deltaX, 0);
          } else {
            _this.props.onDrag(0, deltaY);
          }
        } else {
  ...
  _createClass(DraggableRect, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          _this$props2$styles$p = _this$props2$styles.position,
          centerX = _this$props2$styles$p.centerX,
          centerY = _this$props2$styles$p.centerY,
          _this$props2$styles$s = _this$props2$styles.size,
          width = _this$props2$styles$s.width,
          height = _this$props2$styles$s.height,
          rotateAngle = _this$props2$styles.transform.rotateAngle;
      var style = {
        position: 'absolute',
        width: Math.abs(width),
        height: Math.abs(height),
...
_defineProperty(DraggableRect, "propTypes", {
  className: PropTypes.string,
  children: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
  styles: PropTypes.object,
...
function (_Component) {
  ...
  function Draggable() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Draggable)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Draggable, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(DraggableRect, {
        children: children,
        className: className,
        styles: styles,
...
exports.ResizableRotatable = ResizableRotatable;
